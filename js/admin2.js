...
const precioMaquina = (arrayDeComponentes) => {
    let precioComponenteIndividual = 0
    arrayDeComponentes.forEach(componente => {  
        precioComponenteIndividual += precioComponente(componente)
    })
    return precioComponenteIndividual 
 }
